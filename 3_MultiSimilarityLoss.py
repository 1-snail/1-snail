...
loss = losses.MultiSimilarityLoss(alpha=0.1, beta=40, base=0.5)
...
save_name=str(datetime.datetime.strftime(curr_time,'%Y-%m-%d_%H:%M:%S.txt'))
save_name = "MultiSimilarityLoss_{}_{}".format(num_epochs,save_name)
